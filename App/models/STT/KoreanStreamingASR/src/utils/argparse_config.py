...
def setup_arg_parser():
    ...
    parser.add_argument('--denoiser_model_path', type=str, default="/workspace/LangEyE/App/models/STT/KoreanStreamingASR/checkpoint/denoiser.th",
                        help="path to denoiser model checkpoint")

    parser.add_argument('--asr_model_path', type=str, default="/workspace/LangEyE/App/models/STT/KoreanStreamingASR/checkpoint/Conformer-CTC-BPE.nemo",
