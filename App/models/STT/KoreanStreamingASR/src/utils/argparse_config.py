...
def setup_arg_parser():
    ...
    parser.add_argument('--denoiser_model_path', type=str, default="models/STT/Korean-Streaming-ASR/checkpoint/denoiser.th",
                        help="path to denoiser model checkpoint")

    parser.add_argument('--asr_model_path', type=str, default="models/STT/Korean-Streaming-ASR/checkpoint/Conformer-CTC-BPE.nemo",
