...
import numpy as np
import librosa
from STT.src.jaso import jaso
from src.check_device import check_device

import warnings
warnings.filterwarnings('ignore')

from STT.src.GetSpeech import get_speech
...
def stt_run():
    ...
    input_values = tmp.input_values.to(device)
    with torch.no_grad():
        input_values = input_values.type(torch.FloatTensor).to(device)
